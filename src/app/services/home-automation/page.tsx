...
export const metadata: Metadata = {
  ...
  keywords: [
    "home automation solutions in India",
    "smart home automation systems",
    "smart lighting and security automation",
    "energy efficient smart home",
    "Rayzen Power home automation"
  ],

  alternates: {
    canonical: "https://www.rayzenpower.com/services/home-automation",
  },
    ...
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://www.rayzenpower.com/services/home-automation"
              }
            ]
          })
        }}
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-24 mb-12 space-y-10">
        ...
        <p className="text-lg text-gray-700">
          Our smart home automation integrates seamlessly with &nbsp;
          <Link href="/services/cctv-security" className="text-[#d11a19] font-semibold">
            CCTV security systems
          </Link>&nbsp;
          and energy-efficient power solutions for complete home control.
        </p>
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Home automation allows you to control lighting, appliances, climate, and security systems remotely using smart devices."
                }
              },
              {
                "@type": "Question",
                "name": "Is home automation energy efficient?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, smart automation helps reduce energy consumption by optimizing lighting, climate control, and appliance usage."
                }
              }
            ]
          })
