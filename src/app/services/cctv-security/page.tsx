...
export const metadata: Metadata = {
  ...
  keywords: [
    "CCTV camera installation in India",
    "CCTV security systems for home",
    "CCTV surveillance for business",
    "HD CCTV cameras with night vision",
    "Rayzen Power CCTV solutions"
  ],

  alternates: {
    canonical: "https://www.rayzenpower.com/services/cctv-security",
  },
  openGraph: {
    title: "CCTV Security Cameras - Rayzen Power",
    description:
    ...
    <>
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://www.rayzenpower.com/services/cctv-security"
              }
            ]
          })
        }}
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 mb-16 space-y-8">
        ...
        <p className="text-lg text-gray-700">
          CCTV security camera installation provides real-time monitoring for&nbsp;
          <Link href="/services/home-automation" className="text-[#d11a19] font-semibold">
            smart homes
          </Link>&nbsp;
          and commercial spaces, ensuring advanced protection and surveillance.
        </p>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "How much does CCTV installation cost in India?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "The cost of CCTV installation depends on camera type, number of cameras, and property size. Contact Rayzen Power for a customized quote."
                }
              },
              {
                "@type": "Question",
                "name": "Do CCTV cameras work at night?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, modern CCTV systems include night vision and infrared technology for clear monitoring even in low-light conditions."
                }
              }
            ]
          })
