      ...
      <section className="bg-white py-16 px-4 sm:px-6 lg:px-12 mt-10 relative">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            <p
              className="text-sm font-bold uppercase text-[#d11a19]"
              data-aos="fade-up"
          ...
          <div className="w-full lg:w-1/2">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {[
                ...
                <div
                  key={index}
                  className="h-full bg-white p-6 rounded-xl border border-[#d11a19] hover:border-[#C70F0F] shadow-md hover:shadow-xl transition-all duration-300"
                  data-aos="fade-up"
                  data-aos-duration="2000"
                >
                  <Image
